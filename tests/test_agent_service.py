"""Tests for dispatch_agents._agent_service module.
...
from dispatch_agents._agent_service import AgentServiceClient
...
class TestAgentServiceClientInsecure:
    @pytest.mark.asyncio
    @patch("dispatch_agents._agent_service.service_pb2_grpc.AgentServiceStub")
    @patch("dispatch_agents._agent_service.grpc.aio.insecure_channel")
...
class TestAgentServiceClientSecure:
    @pytest.mark.asyncio
    @patch("dispatch_agents._agent_service.service_pb2_grpc.AgentServiceStub")
    @patch("dispatch_agents._agent_service.grpc.aio.secure_channel")
    @patch("dispatch_agents._agent_service.grpc.ssl_channel_credentials")

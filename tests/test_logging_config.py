"""Tests for dispatch_agents._logging_config module."""
...
class TestParseBoolEnv:
    def test_truthy_values(self):
        from dispatch_agents._logging_config import _parse_bool_env
...
class TestGetLogLevel:
    def test_default_is_warning(self, monkeypatch):
        ...
        from dispatch_agents._logging_config import _get_log_level
...
class TestConfigureLogging:
    def test_sets_level(self, monkeypatch):
        ...
        import dispatch_agents._logging_config as lc
...
class TestGetLogger:
    def test_child_logger(self):
        from dispatch_agents._logging_config import SDK_LOGGER_NAME, get_logger
...
class TestIsVerbose:
    def test_false_by_default(self, monkeypatch):
        ...
        from dispatch_agents._logging_config import is_verbose
